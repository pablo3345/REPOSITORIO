 ...
 * @author pablo
 */
public class RepositorioDimension {

    public void guardarDimension(Dimension dimension) {
    ...
    public ArrayList<Dimension> obtenerTodos() //ArrayList<Empleado> = significa que el arrayList es solo de Foto
    {
        ArrayList<Dimension> arrayADevolver = null;
        ...
        try {
            ...
            arrayADevolver = (ArrayList<Dimension>) session.createQuery("FROM Dimension").list();
