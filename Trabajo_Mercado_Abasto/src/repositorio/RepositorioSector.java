...
public class RepositorioSector {
    ...
    public ArrayList<Sector> obtenerTodos() //ArrayList<Empleado> = significa que el arrayList es solo de Foto
    {
        ArrayList<Sector> arrayADevolver = null;
        ...
        try {
            ...
            arrayADevolver = (ArrayList<Sector>) session.createQuery("FROM Sector").list();
