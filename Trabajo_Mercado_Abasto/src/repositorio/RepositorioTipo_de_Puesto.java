 ...
 * @author pablo
 */
public class RepositorioTipo_de_Puesto {
    
      public void guardarTpoDePuesto(TipoDePuesto tipoDePuesto) {
        ...
        try {
           ...
           public ArrayList<TipoDePuesto> obtenerTodos()
     //ArrayList<Empleado> = significa que el arrayList es solo de Foto
    {
        ArrayList<TipoDePuesto> arrayADevolver = null;
       ...
       // return this.listaEmpleados.toArray(arrayADevolver);
        ...
        try {
         ...
         arrayADevolver = (ArrayList<TipoDePuesto>) session.createQuery("FROM TipoDePuesto").list(); 
